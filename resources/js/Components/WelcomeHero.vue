	  ...
	  <div class="max-w-7xl mx-auto">
	    <div class="relative z-10 pb-8 bg-white sm:pb-16 md:pb-20 lg:max-w-2xl lg:w-full lg:pb-28 xl:pb-32">
	      ...
	      <div>
	          ...
	          <nav class="relative flex items-center justify-between sm:h-10 lg:justify-start" aria-label="Global">
	            <div class="flex items-center flex-grow flex-shrink-0 lg:flex-grow-0">
	              <div class="flex items-center justify-between w-full md:w-auto">
	                ...
	                <div class="-mr-2 flex items-center md:hidden" @click.prevent="toggleHambuger()">
	            ...
	            <div class="hidden md:block md:ml-10 md:pr-4 md:space-x-8">
	              ...
	              <a href="#" class="font-medium text-gray-500 hover:text-gray-900">Speakers</a>

	              <!-- <a href="#" class="font-medium text-gray-500 hover:text-gray-900">Schedule</a> -->

	              <a href="#" class="font-medium text-indigo-600 hover:text-indigo-500">Blog</a>
	        ...
	        -->
	        <div v-show="hambuggermenu" class="absolute top-0 inset-x-0 p-2 transition transform origin-top-right md:hidden">
	          <div class="rounded-lg shadow-md bg-white ring-1 ring-black ring-opacity-5 overflow-hidden">
	            <div class="px-5 pt-4 flex items-center justify-between">
	              <div>
	                <img class="h-8 w-auto" src="https://tailwindui.com/img/logos/workflow-mark-indigo-600.svg" alt="">
	              </div>
	              <div class="-mr-2" @click="toggleHambuger">
...
<script>
	export default {
		...
		methods: {
			toggleHambuger() {
				console.log('clicked')
				this.hambuggermenu = !this.hambuggermenu
			}
		}
	}
</script>